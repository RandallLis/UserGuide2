...
LCD from farenheit to celsius by pressing a pushbutton. The purpose of this program is to use a DHT11 Temperature 
...
if (ButtonState == HIGH){  // States that lines 36 to 49 only apply if the ButtonState is LOW (push button is not being pressed)
